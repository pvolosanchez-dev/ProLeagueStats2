...
import { LandingPage, LoginPage, RegisterPage, DashboardPage, LeaguesPage, CreateLeaguePage, LeagueDetailPage, TeamDetailPage, ProfilePage, UserProfilePage, AwardsPage, SchedulePage, GroupStagePage } from '@/pages';
