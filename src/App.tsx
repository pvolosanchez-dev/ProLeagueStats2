...
import { LandingPage, LoginPage, RegisterPage, DashboardPage, LeaguesPage, CreateLeaguePage, LeagueDetailPage, TeamDetailPage, ProfilePage, UserProfilePage, AwardsPage, SchedulePage, ScheduleEditorPage, GroupStagePage } from '@/pages';
...
export default function App() {
  return <BrowserRouter><Routes>
    ...
    <Route path="/dashboard/leagues/:leagueId/group-stage" element={<ProtectedRoute><DashboardLayout><GroupStagePage /></DashboardLayout></ProtectedRoute>} />
    ...
    <Route path="/dashboard/leagues/:leagueId/schedule-editor" element={<ProtectedRoute><DashboardLayout><ScheduleEditorPage /></DashboardLayout></ProtectedRoute>} />
