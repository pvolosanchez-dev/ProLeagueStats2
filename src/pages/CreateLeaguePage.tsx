...
export function CreateLeaguePage() {
  ...
  const handleSubmit = async (
    ...
    if (!name.trim()) {
      setError(
        'Escribe un nombre para la liga.',
      );
      return;
    }
      ...
      >
        ...
        <section className="card space-y-5 p-6">
          ...
          <div>
            ...
            <label
              htmlFor="league-logo"
              className="flex cursor-pointer items-center gap-4 rounded-xl border border-dashed border-neutral-300 p-4 hover:bg-neutral-50"
            >
          ...
          <label className="flex items-start gap-3">
            ...
            <span>
              ...
              <span className="block text-xs text-neutral-500">
                Los usuarios podrán encontrarla
                en el explorador de ligas.
              </span>
            </span>
          </label>
        ...
        <section className="card space-y-5 p-6">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Puedes cambiar estas reglas más
              adelante mediante la administración
              de la liga.
            </p>
          </div>
